...
public class NetworkUtilsTest {
    ...
    public void testGetLocalIpAddress() throws Exception {
        ...
        assertEquals("192.168.0.140", localIpAddress, "The current network interface with which I am connected to the internet is Wi-Fi and checking with the command ps1 \"NetIPAddress\" returns this value");
    }
